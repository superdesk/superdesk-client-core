...
import {IDropdownConfig, IDropdownValue, IDropdownOption} from '.';
...
export class Config extends React.PureComponent<IConfigComponentProps<IDropdownConfig>, IState> {
    constructor(props) {
        super(props);

...
import {BoxedListItem, BoxedListContentRow} from 'superdesk-ui-framework/react';
...
export class Comment extends React.PureComponent<{comment: IComment; users: {[key: string]: IUser}}> {
            ...
            if (mentions.length) {
                ...
                mentions.forEach((mention) => {
                    ...
                    if (mention.type === 'user') {
                        ...
                        result.push(
                            <span style={{color: '#3d8fb1'}} key={'mentionDesk' + indexFrom}>
                                {mentionText}
                            </span>,
                        );
                    }
    ...
    render() {
        ...
        return (
            <BoxedListItem media={comment.user ? <UserAvatar user={comment.user} /> : null}>

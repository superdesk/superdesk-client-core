...
describe('authoring ChangeImageController', () => {
    ...
    describe('saveAreaOfInterest', () => {
        it('can notify error if crop is invalid', inject((api, $rootScope, $q, notify, content) => {
        ...
        it('can generate picture crop using api save', inject((api, $rootScope, $q, notify, content) => {
            let scope = angular.copy(scopeData);
            let croppingData = {
                CropRight: 2500,
                CropLeft: 0,
        ...
        it('can notify error if picture_crop fails', inject((api, $rootScope, $q, notify, content) => {
            let scope = angular.copy(scopeData);
            let croppingData = {
                CropRight: 2500,
                CropLeft: 0,
        ...
        it('can notify error if picture_renditions fails', inject((api, $rootScope, $q, notify, content) => {
            let scope = angular.copy(scopeData);
            let croppingData = {
                CropRight: 2500,
                CropLeft: 0,
        ...
        it('can save new area of interest', inject((api, $rootScope, $q, notify, content) => {
            let scope = angular.copy(scopeData);
            let croppingData = {
                CropRight: 2500,
                CropLeft: 0,
        ...
        it('sets default poi if not defined', inject((api, $rootScope, $q, notify, content) => {

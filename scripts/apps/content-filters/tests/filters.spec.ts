describe('content filters', () => {
    ...
    beforeEach(inject(($rootScope, $controller, contentFilters, $q, api, $location, $window, notify) => {
        $scope = $rootScope.$new();
    ...
    it('can call production test for matching results', inject((
        $rootScope,
        notify,
        contentFilters,
        $timeout,
    ...
    it('can call production test for non-matching results', inject((
        $rootScope,
        notify,
        contentFilters,
        $timeout,

...
function PreviewItemDirective(planning, api, notify, es) {
    return {
        templateUrl: 'scripts/apps/planning/views/item-preview.html',
        scope: {
            origItem: '=item'
        },
...
function AssigneeBoxDirective(api, desks, userList) {
    return {
        templateUrl: 'scripts/apps/planning/views/assignee-box.html',
        scope: {
            userId: '=',
            deskId: '=',
            hideAssignee: '='
...
function CoverageTypeDirective() {
    return {
        templateUrl: 'scripts/apps/planning/views/coverage-type.html',
    ...
    .config(['superdeskProvider', function(superdesk) {
        superdesk
            .activity('/planning/', {
                ...
                templateUrl: 'scripts/apps/planning/views/planning.html',

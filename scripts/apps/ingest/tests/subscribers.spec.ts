describe('subscribers service', () => {
    ...
    it('can get all subscribers', (done) =>
        inject((subscribersService, $rootScope) => {
    ...
    it('can get all active subscribers', (done) =>
        inject((subscribersService, $rootScope) => {
    ...
    it('can get all targetable subscribers', (done) =>
        inject((subscribersService, $rootScope) => {

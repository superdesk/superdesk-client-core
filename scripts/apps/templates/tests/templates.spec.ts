describe('templates', () => {
    ...
    describe('templates widget', () => {
        ...
        // TODO: rewrite as e2e test; this test is very fragile due to being tightly coupled to feature implementation
        xit('can update template', (done) =>
            inject(($controller, api, $rootScope, session) => {
        ...
        // TODO: rewrite as e2e test; this test is very fragile due to being tightly coupled to feature implementation
        xit('can create new using old template data', (done) =>
            inject(($controller, api, $rootScope, session) => {
                var item = _.create({slugline: 'foo', template: '123'});
                var ctrl = $controller('CreateTemplateController', {item: item});
    ...
    describe('templates service', () => {
        ...
        it('can fetch templates all templates with user type user with privileges', inject((
            api,
            templates,
            privileges,
            desks,
            ...
            spyOn(desks, 'fetchCurrentUserDesks').and.returnValue($q.when([{_id: 'finance'}, {_id: 'sports'}]));
        ...
        it('can fetch templates all templates with user type as administrator', inject((
            api,
            templates,
            session,
            $rootScope,
        ...
        it('can fetch templates all templates with type parameter as administrator', inject((
            api,
            templates,
            session,
            $rootScope,
        ...
        it('can fetch templates all templates with type parameter and template name', inject((
            api,
            templates,
            $rootScope,
        ) => {

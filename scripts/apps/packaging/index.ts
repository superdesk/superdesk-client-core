 ...
 */
angular
    .module('superdesk.apps.packaging', ['superdesk.core.api', 'superdesk.core.activity', 'superdesk.apps.authoring'])
            ...
            superdesk
                ...
                .activity('packageitem', {
                    ...
                    additionalCondition: [
                        ...
                        'item',
                        '$rootScope',
                        function (authoring, item, $rootScope) {
                            return (
                                authoring.itemActions(item).package_item &&
                                !(
                                    $rootScope.config &&
                                    $rootScope.config.features &&
                ...
                .activity('combineinpackage', {
                    ...
                    additionalCondition: [
                        ...
                        function (authoringWorkspace: AuthoringWorkspaceService, item, authoring) {
                            ...
                            return (
                                openItem &&
                                openItem.type !== 'composite' &&
                                openItem._id !== item._id &&
                                actions.add_to_current
                            );
                        },
                    ],

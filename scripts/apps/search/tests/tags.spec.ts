describe('Tag Service', () => {
    ...
    it('can populate keywords from location', (done) =>
        inject(($location, tags, $rootScope, desks, $q) => {
            ...
            tags.initSelectedFacets().then((members) => {
    ...
    it('can populate parameters from location', (done) =>
        inject(($location, tags, $rootScope, desks, $q) => {
    ...
    it('can populate type facet from location', (done) =>
        inject(($location, tags, $rootScope, desks, $q) => {
    ...
    it('can populate date facet from location', (done) =>
        inject(($location, tags, $rootScope, desks, $q) => {
    ...
    it('can populate complete filters from location', (done) =>
        inject(($location, tags, $rootScope, desks, $q) => {
            $location.search(['type=["text","composite"]', 'q=slugline:(FBI) (Obama) (Australia)'].join('&'));
            $rootScope.$apply();
    ...
    it('create tags for from desk and to desk', (done) =>
        inject(($location, $rootScope, $q, tags, _desks_) => {
            var desks = _desks_;
            ...
            tags.initSelectedFacets().then((tagsList) => {
    ...
    it('create tags original creator', (done) =>
        inject(($location, $rootScope, $q, tags, desks, _userList_) => {
    ...
    it('create tags if creator is not known', (done) =>
        inject(($location, $rootScope, $q, tags, desks, _userList_) => {
            var userList = _userList_;
    ...
    it('create tags for unique name', (done) =>
        inject(($location, $rootScope, $q, tags, desks) => {
    ...
    it('create tags for ingest provider', (done) =>
        inject(($location, $rootScope, $q, tags, desks, ingestSources) => {
            var providers = [
                {
                    name: 'Test Provider',
                    _id: 123,
    ...
    it('create tags for remove source facet', (done) =>
        inject(($location, $rootScope, $q, tags, desks) => {
            spyOn(desks, 'initialize').and.returnValue($q.when({deskLookup: deskList}));
    ...
    it('create tags for remove desk facet', (done) =>
        inject(($location, $rootScope, $q, tags, desks) => {
            spyOn(desks, 'initialize').and.returnValue($q.when({}));
    ...
    it('create tags for remove category facet', (done) =>
        inject(($location, $rootScope, $q, tags, desks) => {
            spyOn(desks, 'initialize').and.returnValue($q.when({deskLookup: deskList}));
    ...
    it('create tags for remove urgency facet', (done) =>
        inject(($location, $rootScope, $q, tags, desks) => {
            spyOn(desks, 'initialize').and.returnValue($q.when({deskLookup: deskList}));

...
angular.module('superdesk.apps.workspace.menu', []).provider('workspaceMenu', WorkspaceMenuProvider);
 ...
 */
angular
    .module('superdesk.apps.workspace', ['superdesk.apps.workspace.content', 'superdesk.apps.workspace.menu'])

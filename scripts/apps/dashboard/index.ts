...
angular.module('superdesk.apps.dashboard.widgets', []).provider('dashboardWidgets', svc.DashboardWidgets);

angular
    .module('superdesk.apps.dashboard.widgets.base', ['superdesk.core.itemList'])
...
angular
    .module('superdesk.apps.dashboard')
    .component('sdWidgetReact', reactToAngular1(WidgetReact, ['widget', 'article']))

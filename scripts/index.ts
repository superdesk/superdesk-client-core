...
import {appConfig, getUserInterfaceLanguage, debugInfo, authoringReactViewEnabled} from 'appConfig';
import {IConfigurableUiComponents, IConfigurableAlgorithms, IRestApiResponse} from 'superdesk-api';
    ...
    loadConfigs()
        ...
        .then(() => {
            ...
            if (sdApi.user.isLoggedIn()) {
                ...
                httpRequestJsonLocal<IRestApiResponse<any>>({method: 'GET', path: '/subjectcodes'}).then(({_items}) => {
                    store.dispatch({

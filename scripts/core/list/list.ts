...
mod.directive('sdListView', [
    '$location',
    'keyboardManager',
    'asset',
    function ($location, keyboardManager, asset) {
        return {
            scope: {
                select: '&',
                extras: '=',
            ...
            link: function (scope, element, attrs) {
                ...
                scope.$watch('items._meta', (meta) => {
                    ...
                    if (meta) {
                        ...
                        scope.limit =
                            Number(localStorage.getItem('pagesize')) || Number($location.search().max_results) || SIZE;

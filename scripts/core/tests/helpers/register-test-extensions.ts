...
import {IExtension, IDeployConfig} from 'superdesk-api';
...
export function registerTestExtensions(
    ...
    return registerExtensions(superdesk, modal, privileges, lock, session, authoringWorkspace, metadata, deployConfig);
}

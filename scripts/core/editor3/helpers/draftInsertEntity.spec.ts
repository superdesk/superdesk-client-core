...
describe('draftInsertEntity', () => {
    it('inserting a block should not affect the content of existing blocks', () => {
        ...
        const rawStateInitial = {
            blocks: [
                ...
                },
                {
                    ...
                    data: {
                        tag: 'initial',
                        data: '{"numRows":1,"numCols":2,"cells":[[{"blocks":[{"key":"5870d","text":"a","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}},{"blocks":[{"key":"jbsj","text":"b","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}]],"withHeader":false}',
                    },
                },
                {
                    key: '3m10i',
        ...
        expect(JSON.stringify(getRawContentStateWithoutBlockAndEntityKeys(rawStateInitial).blocks)).toBe(
            JSON.stringify(
                getRawContentStateWithoutBlockAndEntityKeys(rawStateAfterEntityInsertionWithoutTheNewBlock).blocks,
            ),
        );
    });
});

...
import {ContentState, convertToRaw, convertFromRaw, RawDraftContentState} from 'draft-js';
...
describe('core.editor3.html.to-html.HTMLGenerator', () => {
    ...
    it('should add anotation to HTML', () => {
        ...
        const result = new HTMLGenerator(convertFromRaw(rawContentState as RawDraftContentState)).html();

...
describe('core.editor3.html.to-html.HTMLGenerator additional', () => {
    it('converts a sentence without formatting', () => {
        ...
        expect(new HTMLGenerator(convertFromRaw(rawContentState)).html()).toBe(
...
<p>abc</p>`
    ...
    it('should add anotation to HTML', () => {
        ...
        const result = new HTMLGenerator(getInitialContent({editorState: rawContentState})).html();

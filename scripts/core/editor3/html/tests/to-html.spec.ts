    ...
    it('converts headings', () => {
        const rawContentState: any = {
            blocks: [
                ...
                {
                    key: '90o9n',
                    text: 'There were at least thirteen families resident in Highlaws at that time.[3] Abdastartus is a genus of lace bugs in the family Tingidae. There are about five described species in Abdastartus.',
                    type: 'unstyled',
                    depth: 0,
                    inlineStyleRanges: [],
                    entityRanges: [],
    ...
    it('converts a blockquote', () => {
        const rawContentState: any = {
            blocks: [
                ...
                {
                    key: '2u79k',
                    text: 'In the past, variant spellings included Heelawes, Hielawes, Highlows, Hielows, and Hylaws.',
                    type: 'unstyled',
                    depth: 0,
                    inlineStyleRanges: [],
                    entityRanges: [],
    ...
    it('converts a simple table', () => {
        const rawContentState: any = {
            blocks: [
                ...
                {key: '2u79k', text: '', type: 'unstyled', depth: 0, inlineStyleRanges: [], entityRanges: [], data: {}},
            ],
            entityMap: {
                '0': {
                    type: 'TABLE',
                                        ...
                                        blocks: [
                                            {
                                                ...
                                                type: 'unstyled',
                                                depth: 0,
                                                inlineStyleRanges: [{offset: 0, length: 5, style: 'SUPERSCRIPT'}],
                                                entityRanges: [],
                                                data: {},
                                            },
                                        ],
                                        ...
                                        blocks: [
                                            {
                                                ...
                                                type: 'unstyled',
                                                depth: 0,
                                                inlineStyleRanges: [{offset: 0, length: 4, style: 'STRIKETHROUGH'}],
                                                entityRanges: [],
                                                data: {},
                                            },
                                        ],
    ...
    it('converts an image', () => {
        const rawContentState: any = {
            blocks: [
                ...
                {key: '60vvd', text: '', type: 'unstyled', depth: 0, inlineStyleRanges: [], entityRanges: [], data: {}},
            ],
            entityMap: {
                '0': {
                    type: 'MEDIA',
                    ...
                    data: {
                        media: {
                            ...
                            _id: 'urn:newsml:localhost:5000:2019-03-28T18:26:53.805271:f47e37fd-a6bd-4a5e-b91d-01b581f04e8c',
                            _type: 'archive',
                            _links: {
                                self: {
                                    title: 'Archive',
                                    href: 'archive/urn:newsml:localhost:5000:2019-03-28T18:26:53.805271:f47e37fd-a6bd-4a5e-b91d-01b581f04e8c',
                                },
                            },
                            _latest_version: 2,
                            selected: false,
  ...
  <li>Hielows, and Hylaws.</li>
    ...
    it('converts an embed', inject(() => {
        const rawContentState: any = {
            blocks: [
                ...
                {key: 'egj1u', text: '', type: 'unstyled', depth: 0, inlineStyleRanges: [], entityRanges: [], data: {}},
            ],
            entityMap: {
                '0': {
                    type: 'EMBED',
                    ...
                    data: {
                        data: {
                            ...
                            description:
                                "Music video by Mother Mother performing It's Alright. © 2019 Mother Mother Music Inc., under exclusive license to Universal Music Canada Inc.\n\nhttp://vevo.ly/V49vkg",
                            thumbnail_url: 'https://i.ytimg.com/vi/G5-KJgVsoUM/maxresdefault.jpg',
                            thumbnail_width: 1280,
                            thumbnail_height: 720,
                            html: '<div><div style="left: 0; width: 100%; height: 0; position: relative; padding-bottom: 56.2493%;"><iframe src="//cdn.iframe.ly/api/iframe?url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DG5-KJgVsoUM&amp;key=87ca3314a9fa775b5c3a7726100694b0" style="border: 0; top: 0; inset-inline-start: 0; width: 100%; height: 100%; position: absolute;" allowfullscreen scrolling="no" allow="autoplay; encrypted-media"></iframe></div></div>',
                            cache_age: 86400,
                        },
                    },
                },
    ...
    it('converts nested inline styles', () => {
        const rawContentState: any = {
            blocks: [
                {
                    key: 'fcbn3',
                    text: 'The name of Highlaws comes from the Old English hēah-hlāw, meaning "high mounds". In the past, variant spellings included Heelawes, Hielawes, Highlows, Hielows, and Hylaws.',
                    type: 'unstyled',
                    depth: 0,
                    inlineStyleRanges: [
    ...
    it('converts an attachement', () => {
        const rawContentState: any = {
            ...
            entityMap: {
                '0': {type: 'LINK', mutability: 'MUTABLE', data: {link: {attachment: '5c9dd26d149f114c61d84db0'}}},
            },
        };
                            ...
                            highlightsData: {
                                'ANNOTATION-1': {
                                    data: {
                                        ...
                                        msg:
                                            '{"blocks":[{"key":"ejm11","text":"Annotation 1","type":"unstyled",' +
                                ...
                                'ANNOTATION-2': {
                                    data: {
                                        ...
                                        msg:
                                            '{"blocks":[{"key":"9i73f","text":"Annotation 2","type":"unstyled",' +
                                            '"depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},' +
...
<!-- EMBED END Image {id: "editor_0"} -->`,
    ...
    it('should correctly parse tables', () => {
        ...
        expect(html).toBe(
            '<table><tbody><tr><td><p>a</p></td><td></td><td><p>c</p></td></tr>' +

...
class SpellcheckerContextMenuComponent extends Component {
    ...
    addWord(e) {
        ...
        this.props.replaceWord({word: word, newWord: word.text});
    }
...
const mapDispatchToProps = (dispatch) => ({
    // on replace action there are 2 updates on editorState, one generated by close menu
    // and one generated by replace word. The last one is delayed until the first one is
    // done by using setTimeout (see: https://www.quora.com/What-does-setTimeout-with-a-0ms-delay-do).

...
function check(str: string): Promise<Array<ISpellcheckWarning>> {
    ...
    return spellcheck.getDict().then(() => {
    ...
    const actions: {[key: string]: ISpellcheckerAction} = {
        addToDictionary: {
            ...
            perform: (warning: ISpellcheckWarning) =>
                ng.getService('spellcheck').then((_spellcheck) => {
        ...
        return {
            ...
            getSuggestions: (str) =>
                httpRequestJsonLocal<ISpellcheckWarning>({
                    ...
                    (spellcheckerWarning) => spellcheckerWarning.suggestions,
                    (err) => [],
                ),
            actions: {

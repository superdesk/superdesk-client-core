...
describe('editor3.handlePastedText', () => {
    it('should insert text without selection', () => {
        const editorState = EditorState.createWithContent(ContentState.createFromText('paste before this'));
    ...
    it('should insert text with selection at the end', () => {
        let editorState = EditorState.createWithContent(ContentState.createFromText('paste after this '));
        const pastedContent = ContentState.createFromText('some text');
    ...
    describe('insertContentInState', () => {
        it('should maintain the data stored on the first block after pasting', () => {
            ...
            const rawState: any = {
                blocks: [
                        ...
                        data: {
                            MULTIPLE_HIGHLIGHTS: {
                                lastHighlightIds: {
                                    ...
                                    ADD_SUGGESTION: 0,
                                    DELETE_SUGGESTION: 0,
                                    TOGGLE_BOLD_SUGGESTION: 0,
                                    TOGGLE_ITALIC_SUGGESTION: 0,
                                    TOGGLE_UNDERLINE_SUGGESTION: 0,
                                    TOGGLE_SUBSCRIPT_SUGGESTION: 0,
                                    TOGGLE_SUPERSCRIPT_SUGGESTION: 0,
                                    TOGGLE_STRIKETHROUGH_SUGGESTION: 0,
                                    BLOCK_STYLE_SUGGESTION: 0,
                                    SPLIT_PARAGRAPH_SUGGESTION: 0,
                                    MERGE_PARAGRAPHS_SUGGESTION: 0,
                                    DELETE_EMPTY_PARAGRAPH_SUGGESTION: 0,
                                    ADD_LINK_SUGGESTION: 0,
                                    REMOVE_LINK_SUGGESTION: 0,
                                    CHANGE_LINK_SUGGESTION: 0,
                                },
                                highlightsStyleMap: {
                                    'ANNOTATION-1': {borderBottom: '4px solid rgba(100, 205, 0, 0.6)'},
                                },
                                highlightsData: {
                                    'ANNOTATION-1': {
                                        data: {
                                            msg: '{"blocks":[{"key":"67k35","text":"test annotation","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}',
                                            annotationType: 'regular',
                                            authorId: '5acb79292e03ed5d2a84bbd6',
                                            author: 'John Doe',
                                            email: 'a@a.com',
                                            date: '2019-04-05T10:41:55.672Z',
                                            avatar: null,
                                        },
                                        type: 'ANNOTATION',
                                    },
                    ...
                    },
                    {
                        ...
                        type: 'unstyled',
                        depth: 0,
                        inlineStyleRanges: [{offset: 7, length: 4, style: 'ANNOTATION-1'}],
                        entityRanges: [],
                        data: {},
                    },
                ],
            ...
            expect(getAnnotationsFromContentState(editorState1.getCurrentContent())[0].body).toBe(
                '<p>test annotation</p>',
            );

            const editorState2 = insertContentInState(editorState1, ContentState.createFromText('first line'), []);

            expect(getAnnotationsFromContentState(editorState2.getCurrentContent())[0].body).toBe(
                '<p>test annotation</p>',
            );
        });
    });

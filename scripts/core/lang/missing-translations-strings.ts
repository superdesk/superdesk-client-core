...
gettext('Send notifications via email'); gettext('feature'); gettext('Enable Feature Preview'); gettext('Located'); gettext('categories');
...
gettext('World clock widget'); gettext('Displaying news ingest statistics. You can switch color themes or graph sources.');
...
gettext('ABSTRACT is too long'); gettext('SLUGLINE is too long'); gettext('HEADLINE is too long'); gettext('{{field}} empty values not allowed');
gettext('{{field}} is a required field'); gettext('{{field}} is too short');

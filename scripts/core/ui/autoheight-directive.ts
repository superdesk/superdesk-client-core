 ...
 *
 */
angular.module('superdesk.core.ui.autoheight', []).directive('sdAutoHeight', [
    '$window',
    function ($window) {
        return {
            require: 'ngModel',
            ...
            link: function (scope, element, attrs, ngModel) {
                ...
                var $win = angular.element($window),
                    ...
                    $mirror = angular
                        .element('<textarea tabindex="-1" ' + 'style="' + mirrorStyleBasic + '"/>')
                        .attr('elastic', true),
                    mirror = $mirror[0],
                    taStyle,
                    borderBox,
                ...
                function initMirror() {
                    ...
                    boxOuter = !borderBox
                        ...
                        : {
                              width:
                                  parseInt(taStyle.getPropertyValue('border-right-width'), 10) +

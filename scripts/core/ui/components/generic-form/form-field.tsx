...
import {VocabularySingleValue} from './input-types/vocabulary-single-value';
...
import {DeskSingleValue} from './input-types/desk-single-value';
import {StageSingleValue} from './input-types/stage-single-value';
import {getMacroSingleValue} from './input-types/macro-single-value';
import {YesNo} from './input-types/yes-no';
import {IFormField, IFormGroup} from 'superdesk-api';
import {SelectMultipleValues} from './input-types/select-multiple-values';
import {NumberComponent} from './input-types/number';
import {Select} from './input-types/select';
import {SelectAsync, SelectMultipleAsync} from './input-types/select-async';

...
describe('superdesk.core.services.asset module', () => {
    ...
    it('can get templateUrl with scripts prefix', () => {
        ...
        expect(templateUrl).toBe(
            'scripts/bower_components/superdesk/app/scripts/superdesk/users/views/user-list-item.html',
        );
    });
    ...
    it('can get templateUrl for absolute path', () => {
        ...
        expect(templateUrl).toBe('http://localhost/scripts/superdesk/users/user-list-item.html');
    });

    it('can get imageUrl', () => {
        var imageUrl = asset.imageUrl('superdesk/users/activity/thumbnail.png');

        expect(imageUrl).toBe('scripts/bower_components/superdesk/app/scripts/superdesk/users/activity/thumbnail.png');
    });

    it('can get imageUrl for relative path', () => {
        var imageUrl = asset.imageUrl('../scripts/superdesk/users/activity/thumbnail.png');

        expect(imageUrl).toBe('scripts/bower_components/superdesk/scripts/superdesk/users/activity/thumbnail.png');
    });
});

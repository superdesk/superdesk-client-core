...
describe('auth interceptor', () => {
    ...
    it('should intercept 401 response, run auth and resend request', inject((
        $injector,
        $q,
        $rootScope,
        session,
    ...
    it('should intercept 401 response and reject the request if payload has credentials 1', (done) =>
        inject(($q, $rootScope, session, request, AuthExpiredInterceptor) => {
            var interceptor = AuthExpiredInterceptor,

        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                scope.changeUserPassword = function () {
                    ...
                    usersService.changePassword(scope.username, scope.oldPassword, scope.password).then(
                        () => {
                            scope.isLoading = false;
                            scope.changePassword = false;
                            scope.password = null;
                ...
                const apiUrl = appConfig.server.url.replace('api/', 'api'); // make sure there is no trailing /
                ...
                scope.$watchGroup(
                    ...
                    function showLogin(triggerLogin) {
                        scope.isLoading = false;

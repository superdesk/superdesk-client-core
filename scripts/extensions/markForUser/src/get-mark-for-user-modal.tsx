...
export function getMarkForUserModal(options: {
    ...
    const {superdesk, markForUser, markForUserAndSend, locked, lockedInOtherSession, markedForUserInitial, message} =
        options;
    ...
    return class MarkForUserModalComponent extends React.Component<IProps, IState> {
        ...
        render() {
            return (
                ...
                >
                    {message == null ? null : (
                        <div className="sd-alert sd-alert--hollow sd-alert--primary sd-alert--small">{message}</div>
                    )}

                    {lockedInOtherSession === true ? (
                        <div>
                            <div className="sd-alert sd-alert--hollow sd-alert--primary sd-alert--small">

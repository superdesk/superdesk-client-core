...
const {SpacerBlock, Spacer, InputLabel} = superdesk.components;
...
export class RundownTemplateViewEdit extends React.PureComponent<IProps, IState> {
    ...
    private initiateEditing(item: IRundownItemBase, skipUnsavedChangesCheck?: boolean) {
         ...
         */
        const rundownItemsAreEqual = (r1: IRundownItemBase, r2: IRundownItemBase) =>
            isEqual(prepareRundownItemForSaving(r1), prepareRundownItemForSaving(r2));
        ...
        handleUnsavedRundownChanges(this.props.rundownItemAction, skipUnsavedChangesCheck ?? false, () => {
            this.props.onRundownItemActionChange(
                prepareForEditing(this.props.rundownItemAction, null, item, (val) => {
                    if (!this.props.readOnly) {
                        this.props.onChange({
                            items: this.getRundownItems().map((_item) =>
                                rundownItemsAreEqual(_item, item) ? dropReadOnlyFields(val) : _item,
                            ),
                        });
                    }
                                ...
                                <ButtonGroup align="end" padded>
                                    {this.props.readOnly ? (
                                        ...
                                        (() => {
                                            ...
                                            return (
                                                <React.Fragment>
                                                    <Button text={gettext('Cancel')} onClick={this.handleCancelling} />
                            ...
                            >
                                <div>
                                    ...
                                    <Spacer v gap="16">
                                        ...
                                        <div>
                                            <InputLabel text={gettext('Generated name for created rundowns')} />
                                ...
                                <Layout.PanelContent>
                                    {rundownItemAction != null && (
                                        <AuthoringReact
                                            ...
                                            getInlineToolbarActions={({hasUnsavedChanges, save, initiateClosing}) => {

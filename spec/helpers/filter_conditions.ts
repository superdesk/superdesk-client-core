...
class FilterConditions {
    filterConditionMenuButton: any;
    addNewFilterConditionButton: any;
    filterConditionNameField: any;
    saveButton: any;
    cancelButton: any;
    list: any;
    valueField: any;
    addPredefinedValueButton: any;
    getRow: (name: any) => any;
    openFilterConditionSettings: (reload?: any) => void;
    addNew: () => any;
    addName: (name: any) => any;
    selectFilterConditionParameter: any;
    addFilterConditionParameter: (value: any) => any;
    openPredefinedValues: () => any;
    save: () => any;
    cancel: () => any;
    edit: (name: any) => any;
    delete: (name: any) => any;

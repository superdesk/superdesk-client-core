...
class ContentFilters {
    ...
    contentFilterMenuButton: any;
    contentFilterNameField: any;
    addSelectedFilterConditionButton: any;
    addSelectedContentFilterButton: any;
    testButton: any;
    addStatementButton: any;
    closeButton: any;
    saveButton: any;
    contentFilterTestField: any;
    previewField: any;
    testResultField: any;
    globalBlockSwitch: any;
    list: any;
    filterConditionDropdown: any;
    getRow: (name: any) => any;
    openContentFilterSettings: (reload?: any) => void;
    addNew: () => any;
    addName: (name: any) => any;
    selectFilterCondition: any;
    addFilterCondition: () => any;
    addContentFilter: () => any;
    save: () => any;
    addTestStory: (guid: any) => any;
    addStatement: () => any;
    selectFilterConditionOnStatement: (name: any, index: any) => void;
    test: () => any;
    close: () => any;
    toggleGlobalBlock: () => any;
    edit: (name: any) => any;

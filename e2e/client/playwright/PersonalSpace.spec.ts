...
test.describe('Personal Space', async () => {
    test('Create and edit article in Personal space', async ({page}) => {
        ...
        await page.locator(s('monitoring-view')).locator(s('article-item=new article')).locator(s('context-menu-button')).click();
    ...
    test('Copy article in Personal space', async ({page}) => {
        ...
        await page.locator(s('monitoring-view')).locator(s('article-item=personal space article 1')).locator(s('context-menu-button')).click();
    ...
    test('Send item from Personal space', async ({page}) => {
        ...
        await page.goto('/#/workspace/monitoring');
        await expect(page.locator(s('monitoring-view')).locator(s('monitoring-group=Sports / Working Stage'))).toBeVisible();
    });
});
